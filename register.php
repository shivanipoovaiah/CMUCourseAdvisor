...
// Check for form submission:
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		if (empty($_POST['andrew_id'])) {
			$errors[] = 'You forgot to enter your andrew ID.';
		} else {
			$e = trim($_POST['andrew_id']);
		}
		...
		if (empty($_POST['lname'])) {
	 	...
	 	// Make the query:
 	 	$q = "INSERT INTO user (andrew_id, fname, lname, pass, badge_id) VALUES ('$e', '$fn', '$ln', '$p',1)";
	...
	<form action="register.php" method="post">
		<p>Andrew ID: <input type="text" name="andrew_id" size="20" maxlength="15" 
		value="<?php if(isset($_POST['andrew_id'])) echo $_POST['andrew_id']; ?>"/> </p>
	 	<p>First Name: <input type="text" name="fname" size="15" maxlength="20" 
		value="<?php if(isset($_POST['fname'])) echo $_POST['fname']; ?>"/></p>
	 	<p>Last Name: <input type="text" name="lname" size="15" maxlength="40" 
